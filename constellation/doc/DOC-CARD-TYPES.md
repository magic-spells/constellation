...
The prefix before the first dash determines a card's type and must be one of these 21. Folder
...
| STYLE | `STYLE-` | `style/` | Design-system token groups (colors, fonts, scales) |
